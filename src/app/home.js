function homeController($scope, $location, DataExtract) {
  this.text = 'My brand new component! - REc';
  var $ctrl = this;
  DataExtract.getRandomRecipe($scope).then(function (randomRecipe) {
    ...
    $scope.randomRecipeId = randomRecipe.data.recipes[0].id;
